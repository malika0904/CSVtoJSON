...
lineReader.on('line', function (str) {
  ...
  else
  {
    ...
    switch (country)
    {
		case 'France' : console.log("It is :: "+country);
						if(row[salt_index]!="")
		...
		case 'United Kingdom' : console.log("It is :: "+country);
						if(row[salt_index]!="")
		...
		case 'Netherlands' : console.log("It is :: "+country);
						if(row[salt_index]!="")
		...
		case 'Canada' : console.log("It is :: "+country);
						if(row[salt_index]!="")
...
//In file there were two instances (USA and United States). So both are captured here.
		case 'USA' : console.log("It is :: "+country);
						if(row[salt_index]!="")
		...
		case 'United States' : console.log("It is :: "+country);
						if(row[salt_index]!="")
						USA.salt=parseFloat(USA.salt)+parseFloat(row[salt_index]);
						if(row[sugar_index]!="")
						USA.sugar=parseFloat(USA.sugar)+parseFloat(row[sugar_index]);
		...
		case 'Australia' : console.log("It is :: "+country);
						if(row[salt_index]!="")
		...
		case 'Germany' : console.log("It is :: "+country);
						if(row[salt_index]!="")
		...
		case 'Spain' : console.log("It is :: "+country);
						if(row[salt_index]!="")
		...
		case 'South Africa' : console.log("It is :: "+country);
						if(row[salt_index]!="")
		...
		case 'Denmark' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Sweden' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Norway' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Belgium' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Switzerland' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Portugal' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Greece' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Italy' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Croatia' : console.log("It is :: "+country);
						if(row[fat_index]!="")
		...
		case 'Albania' : console.log("It is :: "+country);
						if(row[fat_index]!="")
...
fs.writeFile("JSONFile.JSON", txtJSON, function(err) {
    if(err) {
